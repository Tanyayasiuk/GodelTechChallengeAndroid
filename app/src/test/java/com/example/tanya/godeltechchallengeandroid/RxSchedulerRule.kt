...
class RxSchedulerRule : TestRule {
    ...
    private val schedulerFunction = { scheduler: Scheduler  -> SCHEDULER_INSTANCE }

    private val schedulerFunctionLazy = { schedulerCallable: Callable<Scheduler> -> SCHEDULER_INSTANCE }
